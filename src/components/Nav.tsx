    ...
    >
      <div className="max-w-6xl mx-auto px-8 flex items-center justify-between" style={{ height: 72 }}>
        ...
        <div className="hidden md:flex items-center gap-4">
          ...
          <a href={SITE.booking} target="_blank" rel="noopener" className="btn-p">Book Now</a>
        </div>
        ...
        <div className="md:hidden border-t" style={{ borderColor: 'rgba(255,255,255,.4)', background: 'rgba(250,253,255,.95)' }}>
          <div className="max-w-6xl mx-auto px-8 py-5 flex flex-col gap-1">
            ...
            <div className="pt-4 flex flex-col gap-3">
              ...
              <a href={SITE.whatsapp} target="_blank" rel="noopener" className="btn-s text-center">💬 WhatsApp Us</a>
              <a href={SITE.instagram} target="_blank" rel="noopener" className="btn-s text-center">📸 {SITE.instagramHandle}</a>
              <a href={SITE.booking} target="_blank" rel="noopener" className="btn-p text-center">Book Now</a>
            </div>
          </div>
        </div>
      )}
